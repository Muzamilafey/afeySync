...
export interface LoginResult { accessToken?: string; mustChangePassword?: boolean; mfaEnrollmentRequired?: boolean; mfaRequired?: boolean; handoffUrl?: string }
export const authBase = (realm: Realm) => (realm === 'owner' ? '/owner/auth' : '/auth');
export const METHOD_LABEL: Record<MfaMethod, string> = { totp: 'Authenticator app', email: 'Email code', sms: 'SMS code', passkey: 'Passkey' };
