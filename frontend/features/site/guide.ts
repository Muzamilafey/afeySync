    ...
    sections: [
      ...
      },
      {
        ...
        steps: [
          ...
          { title: 'Pay Hero', text: 'Pay Hero is a second way to send M-Pesa prompts. In Pay Hero, open API Keys and copy the Basic Authorization token, and note your payment channel ID (Payment Channels → My Payment Channels). Enter both, then choose whether Pay Hero sends every prompt or only stands in when M-Pesa (Daraja) is not set up. “Test connection” shows the channel the money goes to.' },
