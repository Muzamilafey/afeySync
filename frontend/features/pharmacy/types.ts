export interface StockInfo { onHand: number; usable: number; expired: number; value: number; nearestExpiry?: string }
export interface Item { _id: string; code: string; name: string; genericName?: string; form?: string; strength?: string; unit: string; brand?: string; manufacturer?: string; packUnit?: string; packSize?: number; barcode?: string; category: string; reorderLevel: number; serviceCode?: string; controlled?: boolean; active: boolean; stock?: StockInfo; billingCode?: string; prices?: Partial<Record<string, number>> }
export interface RxItem { _id: string; itemId?: string; drugName: string; dose?: string; frequency?: string; route?: string; durationDays?: number; quantity: number; instructions?: string; dispensedQuantity: number; returnedQuantity?: number; status: string }
