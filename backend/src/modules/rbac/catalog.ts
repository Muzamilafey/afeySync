...
export const PERMISSION_GROUPS: Record<string, { label: string; permissions: Record<string, string> }> = {
  ...
  lab: {
    ...
    permissions: {
      ...
      'lab.walkin': 'Register walk-in and external lab requests (no consultation needed)',
    },
  },
  radiology: {
    label: 'Radiology',
  ...
  pharmacy: {
    ...
    permissions: {
      ...
      'pharmacy.sell': 'Sell medicines over the counter to walk-in customers',
      'prescription.create': 'Prescribe medication',
    },
  },
  medicalreports: { label: 'Medical reports', permissions: { 'medicalreports.view': 'View and print medical reports, sick notes and certificates', 'medicalreports.create': 'Write and sign medical reports, sick notes and certificates' } },
  ...
  communication: { label: 'Communication', permissions: { 'sms.bulk': 'Send bulk SMS to patients' } },
...
export const DEFAULT_ROLES: DefaultRole[] = [
  ...
  },
  {
    ...
    scope: 'tenant',
    permissions: [...clinicalCore, ...P('reports.', 'billing.view', 'finance.view', 'inventory.view', 'hr.view', 'sha.view', 'admin.audit', 'sms.bulk')],
  },
  {
    key: 'medical_superintendent',
    name: 'Medical Superintendent',
    scope: 'tenant',
    permissions: [...clinicalCore, ...P('opd.', 'consultation.', 'inpatient.', 'lab.view', 'radiology.view', 'pharmacy.view', 'reports.', 'sha.view', 'dha.view', 'medicalreports.')],
  },
  {
    key: 'doctor',
    name: 'Doctor',
    ...
    permissions: [
      ...clinicalCore,
      ...P('opd.', 'consultation.view', 'consultation.create', 'consultation.finalize', 'inpatient.view', 'inpatient.admit', 'inpatient.transfer', 'inpatient.discharge', 'nursing.view', 'lab.view', 'lab.order', 'radiology.view', 'radiology.order', 'dental.view', 'mortuary.view', 'medicalreports.view', 'medicalreports.create'),
  ...
  },
  {
    ...
    scope: 'branch',
    permissions: [...clinicalCore, ...P('opd.', 'consultation.view', 'consultation.create', 'consultation.finalize', 'lab.view', 'lab.order', 'radiology.view', 'radiology.order', 'prescription.create', 'sha.view', 'sha.eligibility', 'dha.terminology', 'medicalreports.')],
  },
  { key: 'nurse', name: 'Nurse', scope: 'branch', permissions: [...clinicalCore, ...P('opd.', 'inpatient.view', 'nursing.', 'consultation.view')] },
  {
    ...
    name: 'Receptionist',
    scope: 'branch',
    permissions: [...P('patients.view', 'patients.search', 'patients.create', 'patients.edit', 'frontdesk.', 'appointments.', 'queue.', 'sha.view', 'sha.eligibility', 'dha.registry', 'documents.', 'insurance.view', 'insurance.eligibility', 'lab.walkin')],
  },
  ...
  { key: 'pharmacist', name: 'Pharmacist', scope: 'branch', permissions: [...clinicalCore, ...P('pharmacy.view', 'pharmacy.dispense', 'pharmacy.sell', 'inventory.view')] },
  ...
  { key: 'lab_technologist', name: 'Lab Technologist', scope: 'branch', permissions: [...clinicalCore, ...P('lab.view', 'lab.sample', 'lab.result', 'lab.walkin')] },
  ...
  { key: 'dentist', name: 'Dentist', scope: 'branch', permissions: [...clinicalCore, ...P('dental.', 'prescription.create', 'lab.order', 'radiology.order', 'medicalreports.')] },
  ...
  { key: 'records_officer', name: 'Records Officer', scope: 'tenant', permissions: [...P('patients.', 'documents.', 'reports.view', 'dha.registry', 'medicalreports.view')] },
...
export const PERMISSIONS_ADDED_IN: Record<number, string[]> = {
  ...
  6: ['lab.walkin', 'pharmacy.sell', 'medicalreports.view', 'medicalreports.create', 'sms.bulk'],
};
