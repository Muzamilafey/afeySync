...
import smsCampaignRoutes from './modules/sms/campaigns.routes';
...
import schemeRoutes from './modules/billing/schemes.routes';
...
export function createApp() {
  ...
  api.use('/sms/campaigns', smsCampaignRoutes);
  ...
  api.use('/billing/schemes', schemeRoutes);
  ...
  api.use('/medical-reports', medicalReportRoutes);
  ...
  api.use('/pharmacy', posRoutes);
  api.use('/pharmacy', pharmacyRoutes);
  api.use('/inventory', storesRoutes);
